    ...
    <div className="relative size-full rounded-2xl">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        <div>
          ...
          {description && (
            <p className="mt-3 text-xs mx-w-64 md:text-base">{description}</p>
          )}
        </div>
      </div>
    </div>
  ...
  return (
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        ...
        <BentoTilt className="border border-white/20 relative  mb-7 h-96 w-full overflow-hidden rounded-xl md:h-[65vh]">
          <BentoCard
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-z_violet-300 p-5">
